# 06 Microsoft Foundry에서 생성형 AI를 시작하기
...
![Microsoft Foundry의 로그인 페이지 스크린샷](/img/image84.png) ![Microsoft Foundry의 스크린샷.](/img/image97.png)
...
![Microsoft Foundry의 모델 카탈로그 스크린샷](/img/image99.png)
...
![Microsoft Foundry의 모델 비교 스크린샷](/img/image46.png)
...
![Microsoft Foundry 개요 페이지의 스크린샷](/img/image62.png)
...
![Microsoft Foundry의 Foundry 도구 스크린샷](/img/image16.png)

데모 외에도 Microsoft Foundry는 모델 카탈로그에서 Foundry 도구 및 기타 모델을 테스트하기 위한 플레이그라운드를 제공합니다.

![Microsoft Foundry의 플레이그라운드 스크린샷](/img/image83.png)

![Microsoft Foundry의 채팅 플레이그라운드 스크린샷.](/img/image24.png)
