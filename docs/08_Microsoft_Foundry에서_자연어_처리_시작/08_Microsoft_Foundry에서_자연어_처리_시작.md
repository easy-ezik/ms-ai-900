# 08 Microsoft Foundry에서 자연어 처리 시작
...
서비스| 설명  
---|---  
![Azure 언어 아이콘의 스크린샷.](/img/image88.png) Azure 언어 서비스| 텍스트를 이해하고 분석하는 기능을 포함하는 클라우드 기반 서비스입니다. Azure Language에는 감정 분석, 핵심 구 식별, 텍스트 요약 및 대화형 언어 이해를 지원하는 다양한 기능이 포함되어 있습니다.  
![Azure Translator 아이콘의 스크린샷.](/img/image6.png) Azure Translator 서비스| 텍스트의 의미 체계 컨텍스트를 분석하고 결과적으로 보다 정확하고 완전한 번역을 렌더링하는 번역에 NMT(신경망 기계 번역)를 사용하는 클라우드 기반 서비스입니다.  
...
![고객 서비스를 지원하는 봇 대화의 스크린샷.](/img/image66.png)
...
![Microsoft Foundry 포털의 Azure 언어 페이지 스크린샷](/img/image18.png)
...
![Microsoft Foundry 포털의 Azure Language Playground에서 감정 분석 예제가 있는 스크린샷](/img/image109.png)

![텍스트 번역 예제가 포함된 Microsoft Foundry 포털의 Azure Translator 플레이그라운드 스크린샷](/img/image5.png)
