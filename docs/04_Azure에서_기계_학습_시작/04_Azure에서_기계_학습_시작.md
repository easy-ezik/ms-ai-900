...
![기계 학습 프로세스의 6단계를 보여 주는 다이어그램](/img/image34.png)
...
![5가지 일반적인 기계 학습 작업에 대한 개요 다이어그램.](/img/image94.png)
...
![모델을 학습시키는 7단계를 보여 주는 다이어그램](/img/image11.png)
...
![데이터 수집 파이프라인의 예를 보여 주는 다이어그램](/img/image73.png)
...
![테이블로 변환된 JSON 데이터의 예를 보여 주는 다이어그램](/img/image42.png)
...
![Azure Machine Learning 작업 영역의 스크린샷.](/img/image81.png)
...
![웹 상점의 웹 사이트를 보여주는 다이어그램. 셔츠가 상단에 표시되고 셔츠를 기반으로 한 추천이 하단에 표시됩니다.](/img/image7.png)
...
![여러 그래프를 보여주는 다이어그램. 한 그래프는 예측 값을 파란색 화살표로 강조 표시한 꺾은선형 차트입니다.](/img/image108.png)
...
![실시간 및 일괄 예측의 시각적 표현을 보여주는 다이어그램.](/img/image112.png)
