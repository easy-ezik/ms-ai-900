...
![인코딩 및 디코딩 계층이 있는 변환기 아키텍처의 다이어그램.](../images/image13.png)
...
![3차원 토큰에 대한 벡터 포함 다이어그램](../images/image3.png)
...
![시스템 및 사용자 프롬프트 다이어그램](../images/image98.png)
...
![여러 프롬프트 및 완료가 있는 대화의 다이어그램.](../images/image28.png)
...
![프롬프트에서 컨텍스트를 제공하기 위해 사용되는 검색 강화 생성의 다이어그램입니다.](../images/image27.png)

## 더 나은 프롬프트를 위한 팁

생성된 AI 도우미의 응답 품질은 사용되는 언어 모델뿐만 아니라 제출하는 프롬프트에 따라 달라집니다.

![컨텍스트, 예제 및 구조 요청이 포함된 명확하고 구체적인 프롬프트 다이어그램](../images/image103.png)
...
![모델, 지침 및 도구가 있는 에이전트의 다이어그램.](../images/image92.png)
...
![다중 에이전트 시스템의 다이어그램.](../images/image65.png)
