# 12 Microsoft Foundry에서 Computer Vision 시작
...
Azure Vision 서비스에는 여러 제품이 포함되어 있습니다. Azure Vision 내에는 다음을 비롯한 특정 작업 집합을 처리하는 서비스가 있습니다.
  ...
  * Azure Vision Image Analysis Service: 이미지에서 일반적인 개체를 검색하고, 시각적 기능에 태그를 지정하고, 캡션을 생성하고, OCR(광학 문자 인식)을 지원합니다. ![Microsoft Foundry의 이미지 캡션 예제 스크린샷](/img/image57.png)
  * Azure AI Face 서비스: 이미지에서 사람의 얼굴을 감지, 인식 및 분석합니다. 이미지 분석에서 사용할 수 있는 것 이상으로 확장되는 얼굴 분석을 위한 특정 모델을 제공합니다. ![Microsoft Foundry의 얼굴 감지 예제 스크린샷](/img/image60.png)
...
![스케이트보드에 있는 사람의 다이어그램.](/img/image63.png)
...
![검색된 개체 주위에 경계 상자가 있는 스케이트보더의 다이어그램.](/img/image45.png)
...
Apple| 바나나| 오렌지  
---|---|---  
![사과 다이어그램](/img/image114.png)| ![바나나 다이어그램](/img/image86.png)| ![주황색 다이어그램](/img/image55.png)  
...
![이미지에서 검색된 여러 과일의 다이어그램.](/img/image106.png)
...
![사각형으로 강조 표시된 두 얼굴의 사진입니다.](/img/image87.png)

얼굴 기능을 사용하면 얼굴 특징을 사용하여 코, 눈, 눈썹, 입술 등과 같은 다른 정보를 반환하도록 기계 학습 모델을 학습시킬 수 있습니다.

![얼굴 특성 주위의 데이터를 보여 주는 얼굴 랜드마크 이미지의 스크린샷.](/img/image8.png)
...
![Microsoft Foundry 포털의 스크린샷.](/img/image40.png)
...
![Microsoft Foundry의 비전 페이지 스크린샷.](/img/image43.png)
